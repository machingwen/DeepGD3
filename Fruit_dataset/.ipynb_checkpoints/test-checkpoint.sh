...
# #     CUDA_VISIBLE_DEVICES=$gpu_num python3 tsne_gmm_test_set_image.py --random_seed $seed --relabel --embedding_layer component_classifier --checkpoint_path $ckpt
# 
#     for NAME in 0 1 2 3 4 5 6 7 #4 8 15 18 19 20
#         do
