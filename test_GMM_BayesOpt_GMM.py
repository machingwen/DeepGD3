...
def GMM_Predict_prob(name, opt, features, GMM_0_attribute, GMM_1_attribute, GMM_2_attribute, GMM_3_attribute, GMM_4_attribute, GMM_5_attribute, GMM_6_attribute, GMM_7_attribute, GMM_8_attribute, GMM_9_attribute, GMM_10_attribute, GMM_11_attribute, GMM_12_attribute, GMM_13_attribute, GMM_14_attribute, GMM_15_attribute, GMM_16_attribute, GMM_17_attribute, GMM_18_attribute, GMM_19_attribute, GMM_20_attribute, GMM_21_attribute, GMM_22_attribute, GMM_0,GMM_1,GMM_2,GMM_3,GMM_4,GMM_5,GMM_6,GMM_7,GMM_8,GMM_9,GMM_10,GMM_11,GMM_12,GMM_13,GMM_14,GMM_15,GMM_16,GMM_17,GMM_18,GMM_19,GMM_20,GMM_21,GMM_22):
    ...
    Island_8_pred= get_prob(features, GMM_8.num_components, GMM_8_attribute.means, GMM_8_attribute.covariances, GMM_8_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_9_pred= get_prob(features, GMM_9.num_components, GMM_9_attribute.means, GMM_9_attribute.covariances, GMM_9_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_10_pred= get_prob(features, GMM_10.num_components, GMM_10_attribute.means, GMM_10_attribute.covariances, GMM_10_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_11_pred= get_prob(features, GMM_11.num_components, GMM_11_attribute.means, GMM_11_attribute.covariances, GMM_11_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_12_pred= get_prob(features, GMM_12.num_components, GMM_12_attribute.means, GMM_12_attribute.covariances, GMM_12_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_13_pred= get_prob(features, GMM_13.num_components, GMM_13_attribute.means, GMM_13_attribute.covariances, GMM_13_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_14_pred= get_prob(features, GMM_14.num_components, GMM_14_attribute.means, GMM_14_attribute.covariances, GMM_14_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_15_pred= get_prob(features, GMM_15.num_components, GMM_15_attribute.means, GMM_15_attribute.covariances, GMM_15_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_16_pred= get_prob(features, GMM_16.num_components, GMM_16_attribute.means, GMM_16_attribute.covariances, GMM_16_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_17_pred= get_prob(features, GMM_17.num_components, GMM_17_attribute.means, GMM_17_attribute.covariances, GMM_17_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_18_pred= get_prob(features, GMM_18.num_components, GMM_18_attribute.means, GMM_18_attribute.covariances, GMM_18_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_19_pred= get_prob(features, GMM_19.num_components, GMM_19_attribute.means, GMM_19_attribute.covariances, GMM_19_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_20_pred= get_prob(features, GMM_20.num_components, GMM_20_attribute.means, GMM_20_attribute.covariances, GMM_20_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_21_pred= get_prob(features, GMM_21.num_components, GMM_21_attribute.means, GMM_21_attribute.covariances, GMM_21_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
    Island_22_pred= get_prob(features, GMM_22.num_components, GMM_22_attribute.means, GMM_22_attribute.covariances, GMM_22_attribute.component_probs, factor=std_threshold_dict['tau0']).squeeze()
...
def GMM(features, label, name_list, opt, df, train_component_label, val_component_label, test_component_label):
    ...
    Island_0_prob, Island_1_prob, Island_2_prob, Island_3_prob, Island_4_prob, Island_5_prob, Island_6_prob, Island_7_prob, Island_8_prob, Island_9_prob, Island_10_prob, Island_11_prob, Island_12_prob, Island_13_prob, Island_14_prob, Island_15_prob, Island_16_prob, Island_17_prob, Island_18_prob, Island_19_prob, Island_20_prob, Island_21_prob, Island_22_prob = GMM_Predict_prob(name, opt, features, GMM_0_attribute,GMM_1_attribute,GMM_2_attribute,GMM_3_attribute,GMM_4_attribute,GMM_5_attribute,GMM_6_attribute,GMM_7_attribute,GMM_8_attribute,GMM_9_attribute,GMM_10_attribute,GMM_11_attribute,GMM_12_attribute,GMM_13_attribute,GMM_14_attribute,GMM_15_attribute,GMM_16_attribute,GMM_17_attribute,GMM_18_attribute,GMM_19_attribute,GMM_20_attribute,GMM_21_attribute,GMM_22_attribute, GMM_0, GMM_1, GMM_2, GMM_3, GMM_4, GMM_5, GMM_6, GMM_7, GMM_8, GMM_9, GMM_10, GMM_11, GMM_12, GMM_13, GMM_14, GMM_15, GMM_16, GMM_17, GMM_18, GMM_19, GMM_20, GMM_21, GMM_22)
    ...
    # ALL test sample    
    calculatePerformance(df_all, file_name=f'./output/{opt.seed}/dataset_{opt.seed}_{name}_HBE+_EXP2_ALL_performance.csv')
    
    # IND test sample   
    if len(df_ind) > 0:
        calculatePerformance(df_ind, file_name=f'./output/{opt.seed}/dataset_{opt.seed}_{name}_HBE+_EXP2_IND_performance.csv')
    
    # OOD test sample    
    if len(df_ood) > 0:
        calculatePerformance(df_ood, file_name=f'./output/{opt.seed}/dataset_{opt.seed}_{name}_HBE+_EXP2_OOD_performance.csv')
...
def HybridExpert(y_pred_expert1, y_pred_expert2, y_true, name_label_list, df, opt, train_component_label, val_component_label, test_component_label):
    ...
    # IND test samples
    if len(df_ind) > 0:
        calculatePerformance(df_ind, file_name=f'./output/{opt.seed}/dataset_{opt.seed}_{name}_HBE+_IND_performance.csv')
    
    # OOD test sample
    if len(df_ood) > 0:
        calculatePerformance(df_ood, file_name=f'./output/{opt.seed}/dataset_{opt.seed}_{name}_HBE+_OOD_performance.csv')    
    
    # All test sample
    calculatePerformance(df, file_name=f'./output/{opt.seed}/dataset_{opt.seed}_{name}_HBE+_ALL_performance.csv')
